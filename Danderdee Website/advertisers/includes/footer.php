...
<!--    <script src="/plugins/morris/morris.min.js"></script>-->
    <!-- Sparkline -->
    <script src="<?php echo SERVER ?>/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="<?php echo SERVER ?>/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="<?php echo SERVER ?>/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- jQuery Knob Chart -->
    <script src="<?php echo SERVER ?>/plugins/knob/jquery.knob.js"></script>
    <!-- daterangepicker -->
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo SERVER ?>/dist/js/app.js"></script>
