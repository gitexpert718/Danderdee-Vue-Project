...
<html>
    <head>
        ...
        <!-- <link href="<?php //echo SERVER ?>/css/login-page.css" rel="stylesheet" type="text/css" /> -->
        <!-- <link href="<?php //echo SERVER ?>/css/landing-page.css" rel="stylesheet"> -->
            <!-- iCheck -->
