...
$(function () {
    ...
    var cardHolderNameInput = $('#cardholder-name');
    var cardInputElement = $('#card-input');
    ...
    card.addEventListener('change', function (event) {
        ...
        if (event.error) {
            cardInputElement.addClass('has-error').find('.help-block').html(event.error.message);
        } else {
            cardInputElement.removeClass('has-error').find('.help-block').html('');
        }
    });
    ...
    cardHolderNameInput.on('change', function (e) {
        ...
        if (validateName(this.value)) {
            parent.removeClass('has-error').find('.help-block').html('');
        } else {
            parent.addClass('has-error').children('.help-block').html('Cardholder name is invalid');
        }
    });
    ...
    form.on('submit', function (event) {
        ...
        var name = cardHolderNameInput.val();
