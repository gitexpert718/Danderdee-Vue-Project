                ...
                <div class="col-xs-12 ">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Edit Hardware Types</h3>
...
<script>
            ...
            var app = angular.module('myApp', []);
                app.controller('myCtrl', function($scope, $http) {
                    ...
                    $scope.submit = 'Edit Hardware Types';
                    $scope.user = {
...
//               });
                    ...
                    $scope.create = function() {
                        ...
                        $http({
                            method : "PUT",
                            url : "https://netapi.danderdee.com/api/hardwaretype/<?php echo $_GET['id'] ?>",
                            data : $scope.user
                        }).then(function mySucces(response) {
                            $scope.error = 'Hardware Type Editd Successfully';
                            $scope.isDisabled = false;
                            $scope.submit = 'Edit Hardware Types';
                        }, function myError(response) {
                            console.log(response);
                            ...
                            $scope.isDisabled = false;
                            $scope.submit = 'Edit Hardware Type';
                        });
                    }
                });
