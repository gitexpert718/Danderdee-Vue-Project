    ...
    <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a class="navbar-link" href="#">About<span class="sr-only">(current)</span></a></li>
                <li class="active"><a class="navbar-link" href="#">Services</a></li>
                <li><a class="navbar-link" href="#">Contact</a></li>
                <li>
                    <div class="dropdown">
                        <button type="button" class="btn btn-lg btn-info navbar-btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Advertisers <span class="caret"></span>
                        </button>
                ...
                <li><a class="navbar-link" href="#"><i class="fa fa-home"></i></a></li>
