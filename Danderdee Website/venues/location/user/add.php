              ...
              <!-- general form elements -->
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title">Add User to location</h3>
...
<script>
            var app = angular.module('myApp', []);
                app.controller('myCtrl', function($scope, $http) {
                    ...
                    $scope.submit = 'Add User to Device';
                    $http({
                        method : "GET",
                    ...
                    $scope.check = function() {
                        ...
                        $scope.submit = 'Adding User to Location';
                        $scope.error = 'Adding User to Location........';
                        $http({
                            method : "POST",
                            url : "https://netapi.danderdee.com/api/locations/add/user",
                            data : $scope.user
                        }).then(function mySucces(response) {
                            $scope.error = 'User added to location';
                            $scope.isDisabled = false;
                        }, function myError(response) {
                            console.log(response);
