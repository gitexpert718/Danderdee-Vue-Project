           ...
           $scope.error = ' ';
              ...
              $http({
               ...
               $http({
                    ...
                    method : "GET",
                    url : "https://netapi.danderdee.com/api/spaces",
                    withCredentials: true
                   ...
                   if(response.status == 200)
                   {
                       ...
                       $('#space-table tbody').html('');
                        ...
                        $(response.data).each(function(i,val){
                            ...
                            '<td>' + val.weather + '</td>' +
                            '<td>' + val.mood + '</td>' +
                            '<td><a href="<?php echo SERVER ?>/space/edit.php?id=' + val._id + '" class="btn btn-success btn-xs" title="edit"><i class="glyphicon glyphicon-edit"></i></a><button type="button" class="btn btn-danger btn-xs" title="edit"><i class="glyphicon glyphicon-remove-circle"></i></button></td>' +
