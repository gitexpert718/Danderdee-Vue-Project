<template>
  <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light topnav">
    <button
    ...
    <a class="navbar-brand" href="#">
      <div class="logo navbar-logo" data-href="index.html">
        <svg
          height="100%"
          id="danderdee-logo"
    ...
    <div class="collapse navbar-collapse nav-font" id="navbarTogglerDemo03">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <button
            class="btn btn-lg navbar-btn dropdown-toggle btn-primary-outline"
            type="button"
            id="navbarDropdown"
