  ...
  data() {
    return {
      ...
      options: [
        ...
        { code: "MO", name: "Macao" },
        { code: "MK", name: "Macedonia, the former Yugoslav Republic o" },
        ...
        { code: "SH", name: "Saint Helena, Ascension and Tristan da Cu" },
        ...
        { code: "GS", name: "South Georgia and the South Sandwich Isla" },
